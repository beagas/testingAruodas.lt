...
public class Tests {
    ...
    public void testTC0103() {
        ...
        _globalDriver.findElement(By.id("fieldFBuildYear")).sendKeys("1969");//įvedamas namo plotas
        ...
        _globalDriver.findElement(By.id("priceValue")).sendKeys("420");//įvedamas sklypo plotas
        _globalDriver.findElement(By.id("fieldphone")).sendKeys("61234567");//įvedamas sklypo plotas
        _globalDriver.findElement(By.id("fieldemail")).sendKeys(_email);//įvedamas sklypo plotas
        ...
        _globalDriver.findElement(By.id("formSubmitButton")).click();//sutikti su portalo taisyklėmis
        _globalDriver.close();
